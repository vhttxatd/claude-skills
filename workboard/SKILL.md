...
name: WorkBoard
description: >
  WorkBoard — Danh sách công việc giao ban hàng tuần của Phan Trung Hiếu (KHCN-CĐS, xã An Thới Đông). Theo dõi tiến độ, cập nhật trạng thái, đồng bộ với các nội dung làm việc khác. CHỈ truy cập file dữ liệu khi người dùng gọi đúng trigger để tiết kiệm token.
---

# WorkBoard — Công việc giao ban hàng tuần
